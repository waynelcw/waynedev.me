...
<Text sx={{ fontStyle: `italic`, fontSize: [1]}}>
  ...
  <br />
  Still, I understand and genuinely like the idea of TDD, but BDD and ATDD sound much more useful and a big step closer to the way how human thinks...)
  Will leave this to the actual TDD post until I dig enough to write a self-satisfying blog post.
  <br />
...
The reason is simply about gaining more exposure to cloud.
Also, it is another way to force me to gain more exposure on other unknown fields.
...
- *AWS Developer*
  ...
  - an in-depth exploration of building CI/CD pipelines

#### The thinking

I gave a glance at the AWS Developer materials. 
...
But I would consider getting certified for AWS Developers afterward.
...
Because I believed that was the most energetic period where the human brain functions.

### So on day 3...
I failed to follow the schedule already! <br />
I found that I was not productive nor efficient as I should.<br />
And especially it is not like working in an office or with a team. It is hard to stay focus on a single task by myself.
...
In fact, while I am having breakfast or commuting, I rehearsed in my head about which website I will first tab on my browser and where have I left off last night.
...
Then I found it really useful since it shows me the hard fact that how did my plan goes.
...
I have used some of the on-premise hardware but AWS interpreted the philosophy of why we are having the component with a few more perspectives.<br />
...
It's not the 80s nor the 90s anymore. 
...
But there are different approaches to learn one thing and there are probably better ones that suit you more.
...
So I picked the latter as the primary course line to rely on since I want to expose more in solutions architect.
...
My understanding of those components reinforced when I was trying to draw that on my paper.
Every single line, I will think and sometimes google to see if they could connect.
...
Therefore, before the day of the exam, take a good sleep and use your well-rested brain to read through the questions carefully<br />
Good night!
