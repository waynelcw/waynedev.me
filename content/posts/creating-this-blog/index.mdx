...
- *Medium*
  - I read on Medium, a lot. People write on there is more like publishing their work or astounding thoughts. I do not want my self concerning too much on how random people see and think what I write. I just want a space where I can customise stuffs and play with cool effects from time to time.
...
Considering that I am creating a personal blog and may add a lot of plugins into my blog, Gatsby becomes the winner base on its extensibility and features.

The secondary reason is GraphQL is getting more popular these days. This would be a great place for me to and language.
It was hard to understand the concept since I last worked with it but I do want to give another try.
...
But Netlify provides something more than that like drag& drop interfaces, giant data handling and thumbnail generation.
